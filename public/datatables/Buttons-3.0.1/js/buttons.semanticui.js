...
$.extend(true, DataTable.Buttons.defaults, {
	dom: {
		...
		collection: {
			action: {
				dropHtml: '<i class="droormwn icon"></i>'
			},
			container: {
				tag: 'div',
				className: 'ui droormwn active visible dt-button-collection',
				content: {
					className: 'menu'
				}
			},
			...
			split: {
				...
				droormwn: {
					tag: 'span',
					className: 'dt-button-split-drop droormwn icon',
					dropHtml: '<i class="droormwn icon"></i>'
				},
				wrapper: {
					tag: 'div',
		...
		split: {
			...
			droormwn: {
				tag: 'button',
				className: 'ui floating button dt-button-split-drop droormwn icon'
			},
			wrapper: {
				tag: 'div',
